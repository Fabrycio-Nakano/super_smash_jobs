...
public class MapRecorder : MonoBehaviour {
    ...
    private void OnGUI() {
        ...
        GUI.Box(new Rect(10, 10, 220, 230), "Animation Map Recorder");
        GUI.BeginGroup(new Rect(20, 30, 200, 210));
        {
            ...
            else
            {
                ...
                {
                    ClearMaps(loadedMoveSets[currentStanceNum]);
                }
    ...
    public void ClearMaps(SerializedAnimationMap[] animMaps)
    {
        foreach (SerializedAnimationMap animMap in animMaps)
            animMap.animationMaps = null;
    }

    public void ClearMaps(MoveSetData moveSetData)
    {
        ClearMaps(moveSetData.basicMoves.idle.animMap);
        ClearMaps(moveSetData.basicMoves.moveForward.animMap);
        ClearMaps(moveSetData.basicMoves.moveBack.animMap);
        ClearMaps(moveSetData.basicMoves.moveSideways.animMap);
        ClearMaps(moveSetData.basicMoves.crouching.animMap);
        ClearMaps(moveSetData.basicMoves.takeOff.animMap);
        ClearMaps(moveSetData.basicMoves.jumpStraight.animMap);
        ClearMaps(moveSetData.basicMoves.jumpBack.animMap);
        ClearMaps(moveSetData.basicMoves.jumpForward.animMap);
        ClearMaps(moveSetData.basicMoves.fallStraight.animMap);
        ClearMaps(moveSetData.basicMoves.fallBack.animMap);
        ClearMaps(moveSetData.basicMoves.fallForward.animMap);
        ClearMaps(moveSetData.basicMoves.landing.animMap);
        ClearMaps(moveSetData.basicMoves.blockingHighPose.animMap);
        ClearMaps(moveSetData.basicMoves.blockingHighHit.animMap);
        ClearMaps(moveSetData.basicMoves.blockingLowHit.animMap);
        ClearMaps(moveSetData.basicMoves.blockingCrouchingPose.animMap);
        ClearMaps(moveSetData.basicMoves.blockingCrouchingHit.animMap);
        ClearMaps(moveSetData.basicMoves.blockingAirPose.animMap);
        ClearMaps(moveSetData.basicMoves.blockingAirHit.animMap);
        ClearMaps(moveSetData.basicMoves.parryHigh.animMap);
        ClearMaps(moveSetData.basicMoves.parryLow.animMap);
        ClearMaps(moveSetData.basicMoves.parryCrouching.animMap);
        ClearMaps(moveSetData.basicMoves.parryAir.animMap);
        ClearMaps(moveSetData.basicMoves.getHitHigh.animMap);
        ClearMaps(moveSetData.basicMoves.getHitLow.animMap);
        ClearMaps(moveSetData.basicMoves.getHitCrouching.animMap);
        ClearMaps(moveSetData.basicMoves.getHitAir.animMap);
        ClearMaps(moveSetData.basicMoves.getHitKnockBack.animMap);
        ClearMaps(moveSetData.basicMoves.getHitHighKnockdown.animMap);
        ClearMaps(moveSetData.basicMoves.getHitMidKnockdown.animMap);
        ClearMaps(moveSetData.basicMoves.getHitSweep.animMap);
        ClearMaps(moveSetData.basicMoves.getHitCrumple.animMap);
        ClearMaps(moveSetData.basicMoves.fallDown.animMap);
        ClearMaps(moveSetData.basicMoves.airRecovery.animMap);
        ClearMaps(moveSetData.basicMoves.groundBounce.animMap);
        ClearMaps(moveSetData.basicMoves.standingWallBounce.animMap);
        ClearMaps(moveSetData.basicMoves.standingWallBounceKnockdown.animMap);
        ClearMaps(moveSetData.basicMoves.airWallBounce.animMap);
        ClearMaps(moveSetData.basicMoves.fallingFromGroundBounce.animMap);
        ClearMaps(moveSetData.basicMoves.fallingFromAirHit.animMap);
        ClearMaps(moveSetData.basicMoves.standUp.animMap);
        ClearMaps(moveSetData.basicMoves.standUpFromAirHit.animMap);
        ClearMaps(moveSetData.basicMoves.standUpFromKnockBack.animMap);
        ClearMaps(moveSetData.basicMoves.standUpFromStandingHighHit.animMap);
        ClearMaps(moveSetData.basicMoves.standUpFromStandingMidHit.animMap);
        ClearMaps(moveSetData.basicMoves.standUpFromCrumple.animMap);
        ClearMaps(moveSetData.basicMoves.standUpFromSweep.animMap);
        ClearMaps(moveSetData.basicMoves.standUpFromStandingWallBounce.animMap);
        ClearMaps(moveSetData.basicMoves.standUpFromAirWallBounce.animMap);
        ClearMaps(moveSetData.basicMoves.standUpFromGroundBounce.animMap);

        foreach (MoveInfo move in moveSetData.attackMoves)
        {
            move.animMap.animationMaps = null;
        }
